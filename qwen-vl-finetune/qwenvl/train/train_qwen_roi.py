...
from qwenvl.data.data_processor_roi import make_supervised_data_module
from qwenvl.train.argument import (
    ModelArguments,
    DataArguments,
    TrainingArguments,
)
from tools.constants import ROI_FEAT_TOKEN, DEFAULT_TOKENS
...
def train(attn_implementation="flash_attention_2"):
    ...
    REGION_IDX_TOKENS = ['<r{}>'.format(i) for i in range(model_args.max_region_num)]
    processor.tokenizer.add_tokens([ROI_FEAT_TOKEN] + list(DEFAULT_TOKENS.values()) + REGION_IDX_TOKENS, special_tokens=True)
